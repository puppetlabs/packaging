def pdebuild results_dir, cow = @cow
  begin
...
namespace :pl do
  desc "Create a deb from this repo using the cow #{@cow}."
...
#  desc "Create debs from this git repository using all cows specified in build_defaults.yaml"
 # task :deb_all_cows => "package:tar" do
end
